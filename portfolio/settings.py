...
AWS_ACCESS_KEY_ID = env('AWS_ACCESS_KEY_ID', default=env('ACCESS_KEY_ID'))
AWS_SECRET_ACCESS_KEY = env('AWS_SECRET_ACCESS_KEY', default=env('SECRET_ACCESS_KEY'))
AWS_STORAGE_BUCKET_NAME = env('AWS_STORAGE_BUCKET_NAME', default=env('STORAGE_BUCKET_NAME'))
AWS_S3_REGION_NAME = env('AWS_S3_REGION_NAME', default=env('S3_REGION_NAME'))
